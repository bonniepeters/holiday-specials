...
class Show(models.Model):
    ...
    Year = models.CharField(max_length=60, default='')
    ...
    imdbVotes = models.CharField(max_length=60, default='')
    imdbID = models.CharField(max_length=60, default='')
...
class Episode(models.Model):
    ...
    Released = models.CharField(max_length=60, default='')
    Season = models.PositiveIntegerField(default=1)
    Episode = models.PositiveIntegerField(default=10)
    Runtime = models.CharField(max_length=60, default='')
    Plot = models.TextField(default='')
    Poster = models.TextField(default='')
    imdbRating = models.DecimalField(default=5, max_digits=2, decimal_places=1)
    imdbVotes = models.CharField(max_length=60, default='')
    imdbID = models.CharField(max_length=60, default='')
    imdbSeriesID = models.CharField(max_length=60, default='')
    justWatchUrl = models.CharField(max_length=60, default='')
